...
# overlapping stays, both readmission stays, e-fresh, the three p-twin
# stays, and the three lookback patients' prior and index stays. The minor
# and the in-hospital death are excluded by the cohort rules; e-edge-index
# and e-full-index are discharged after BEFORE.
DISCHARGES_BEFORE = 17
